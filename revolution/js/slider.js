 ...
 tpj(document).ready(function() {
  if(tpj("#rev_slider_4_1").revolution == undefined){
      ...
      revapi41 = tpj("#rev_slider_4_1").show().revolution({
        ...
        responsiveLevels:[1240,1024,778,200],
        visibilityLevels:[1240,1024,778,200],
        gridwidth:[1240,1024,778,200],
        gridheight:[630,700,360,202],
        lazyType:"none",
